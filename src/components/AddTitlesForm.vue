...
<template>
  <div class="bg-gray-100 w-full p-10 ">
            ...
            <div class=" overflow-y-auto" v-for="title in titleStore.titles">
              <div class="p-3 text-lg group uppercase w-full hover:bg-gray-100 border-b flex items-center justify-between text-gray-600">
                ...
                <div class="flex items-center gap-2">
                    <div @click="isUpdateTitle = true" class="group-hover:opacity-100 opacity-0 cursor-pointer text-gray-400">
                    ...
                    <div @click="handleDelete(title.id)" class="group-hover:opacity-100 opacity-0 cursor-pointer text-gray-700">
    ...
    <UpdateTitleModal v-if="isUpdateTitle" @close-modal="isUpdateTitle = false"/>
  </div>
</template>