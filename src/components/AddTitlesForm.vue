...
<template>
  <div class="bg-gray-100 w-full p-10 ">
      ...
      <div class="mt-4 h-full">
          ...
          <div class=" w-full bg-white  border overflow-y-auto">
            <div class=" overflow-y-auto" v-for="title in titles">
              <div class="p-3 text-lg group uppercase w-full hover:bg-gray-100 border-b flex items-center justify-between">
                <div>
                  {{ title.name }}
                </div> 
    ...
    <AddTitlesModal v-if="isModalShow" @close-modal="isModalShow = false"/>
  </div>
</template>