...
<template>
        ...
        <div class="mt-4 h-full">
          ...
          <div class=" w-full h-[83%] bg-white  border overflow-y-auto">
            <div class=" overflow-y-auto" v-for="member in members">
              <div class="p-3 text-lg uppercase w-full hover:bg-gray-100 border-b flex items-center justify-between group">
                <div>
                  {{ member.name }}
                </div>
      ...
      <AddMembersModal v-if="isModalShow" @close-modal="isModalShow = false"/>
    </div>
</template>