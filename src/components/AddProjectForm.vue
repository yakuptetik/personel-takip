...
function handleDelete(project,id) {
    setTimeout(() => {
...
<template>
    <div class="bg-gray-100 w-full p-10">
              ...
              <div class=" overflow-y-auto" v-for="project in projects">
                <div class="p-3 text-lg uppercase w-full hover:bg-gray-50 border-b flex items-center justify-between group text-gray-600">
                  ...
                  <div class="flex items-center gap-2">
                      <div @click="isUpdateProject = true" class="group-hover:opacity-100 opacity-0 cursor-pointer text-gray-400">
                      ...
                      <div @click="handleDelete(project ,id) " class="group-hover:opacity-100 opacity-0 cursor-pointer text-gray-700">
      ...
      <UpdateProjectModal v-if="isUpdateProject" @close-modal="isUpdateProject = false"/>
    </div>
</template>