...
<template>
  <div class="p-3 text-lg  w-full hover:bg-gray-50 border-b flex items-center justify-between group text-gray-600">
      ...
      <div class="flex items-center gap-2">
        <div @click="isUpdateProject = true" @keypress="isUpdateProject = true" class="w-4  transform hover:text-green-600 hover:scale-110">
        ...
        <div @click="handleDelete(project.id)" class="w-4  transform hover:text-red-700 hover:scale-110">
  ...
  <UpdateProjectModal :project="project" v-if="isUpdateProject" @close-modal="isUpdateProject = false"/>
</template>